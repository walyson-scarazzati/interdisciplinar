...
public final class Associado extends Pessoa {
    ...
    public Associado(int id, String nome, String dataNasc, String endereco, String telefone, String email, String rg, String cpf, String profissao, Vector<Dependente> dependentes) {
