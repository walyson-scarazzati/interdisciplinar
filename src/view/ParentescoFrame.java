 ...
 * @author MaqLab
 */
public class ParentescoFrame extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form ParentescoFrame
     */
    ...
    private void loadData() {
        try {
            ...
            for (Parentesco parentesco : dados) {
                ...
                row.add(parentesco.getId());
                row.add(parentesco.getDescricao());
