 ...
 * @author MaqLab
 */
public class MensalidadeFrame extends javax.swing.JInternalFrame {
    Mensalidade  obj;
    MensalidadeData  DAO;
    int acao = 0;
    ...
    private void initComponents() {
        ...
        jtDatapgto.setFocusable(false);
        jtDatapgto.setBackground(new java.awt.Color(195, 195, 195));
        jtDatapgto.setForeground(new java.awt.Color(90, 90, 90));
        try {
    ...
    private void jbPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbPesquisarActionPerformed
            ...
            if (jcNroContrato.getSelectedIndex() <= 0) {
                JOptionPane.showMessageDialog(this, "Selecione o número do contrato para pesquisar");
                return;
            }
            try{
                DAO = new MensalidadeData();
                int nroContrato = contratos.get(jcNroContrato.getSelectedIndex()).getNroContrato();
                obj = DAO.pesquisarPorContrato(nroContrato);
                if(obj == null){
                    ...
                    jcNroContrato.setEnabled(true);
                     ...
                     for(int i=0;i<contratos.size();i++){
                         if(contratos.get(i).getNroContrato()==obj.getContrato().getNroContrato())
