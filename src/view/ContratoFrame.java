 ...
 * @author MaqLab
 */
public class ContratoFrame extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form ContratoFrame
     */
        ...
        if (jtNroContrato.getText().equals("")) {
            ...
            try {
                ...
                if (obj == null) {
                    ...
                    jtDataCon.setText(obj.getDataContrato());
                    jtDataCancelar.setText(obj.getDataCancelamento());
