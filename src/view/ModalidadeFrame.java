...
import data.ModalidadeEsportivaData;
 ...
 * @author MaqLab
 */
public class ModalidadeFrame extends javax.swing.JInternalFrame {

    ModalidadeEsportiva obj;
    ModalidadeEsportivaData DAO;
    Vector<Categoria> vetorCategoria;
    int acao = 0;

    /**
     * Creates new form ModalidadeFrame
     */
    ...
    private void loadData() {
        try {
            DAO = new ModalidadeEsportivaData();
            Vector<ModalidadeEsportiva> dados = DAO.listarModalidadeEsportiva();
            ...
            for (ModalidadeEsportiva modalidade : dados) {
                Vector<Object> row = new Vector<>();
                row.add(modalidade.getId());
            ...
            jtbPesquisar.getColumnModel().getColumn(0).setMinWidth(0);
            jtbPesquisar.getColumnModel().getColumn(0).setMaxWidth(0);
            jtbPesquisar.getColumnModel().getColumn(0).setPreferredWidth(0);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jtbPesquisar.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Descrição", "Categoria de Plano"
            }
        ) {
    ...
    private int getSelectedRowId() {
        ...
        return (Integer) jtbPesquisar.getValueAt(selectedRow, 0);
    }
